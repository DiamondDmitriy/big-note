...
import { NAME_MES_INVALID_REGEX, NAME_REGEX } from '@/shared/validators/field.ts'
import { LOGIN_MES_INVALID_REGEX, LOGIN_REGEX } from '@/shared/validators/login.ts'
import { CURRENT_YEAR, generateDays, generateYears, getMonths } from '@/shared/lib/datetime'
import { EMAIL_MES_INVALID_REGEX, EMAIL_REGEX } from '@/shared/validators/email.ts'
import {
...
import RegistrationRequest from '@/pages/auth/api/registration.request.ts'
import { useUserStore } from '@/features/user/user.store.ts'
import UserEntity from '@/entities/user/user.entity.ts'
import { SignUp } from '@/app/router/routes/auth.route.ts'
