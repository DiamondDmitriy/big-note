...
import ThemeSwitch from '@/components/site/ThemeSwitch.vue'
...
import SignInRecoveryModal from '@/views/auth/SignInRecoveryModal.vue'
import { SignIn, SignUp } from '@/router/routes/auth.route.ts'
